...
@Autonomous(name= "BettaCVRedSkystoneFoundation", group = "DriveTrain")
public class BettaCVRedSkystoneFoundation extends LinearOpMode {
...
//                    -3, 0);
            ...
            // get the foundation
            robot.drive("d", robot.TS, 35,
                    35, 0);
//            robot.drive("s", .3, -30,
//                    -30, 0);
//            robot.drive("s", .3, 6,
//                    6, 0);
            robot.drive("d", robot.TS, 22,
                    -22, 90);
...
//                    -3, 0);
            ...
            // get the foundation
            robot.drive("d", robot.TS, 20,
                    20, 0);
            robot.drive("s", .3, -30,
                    -30, 0);
            robot.drive("s", .3, 6,
                    6, 0);
            robot.drive("d", robot.TS, 21,
                    -21, 90);
            robot.drive("d", .25, -37,
                    -37, 0);
