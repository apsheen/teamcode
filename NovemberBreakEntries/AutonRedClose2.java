...
@Autonomous(name="AutonRed2", group="DriveTrain")
public class AutonRedClose2 extends LinearOpMode {
    ...
    public void autonInstructions() {
        // faster auton
        encoderDrive(TRANSLATE_SPEED, 35, 35);
        ...
        encoderDrive(TRANSLATE_SPEED, -17, 17);
        encoderDrive(TRANSLATE_SPEED, 30, 30);
        manipOpen();

        encoderDrive(TRANSLATE_SPEED, -60, -60);
        encoderDrive(TRANSLATE_SPEED,  17, -17);
        encoderDrive(TRANSLATE_SPEED, 35, 35);
        encoderStrafe(TRANSLATE_SPEED, -6, -6);
        encoderDrive(TRANSLATE_SPEED, 17, -17);
        ...
        encoderDrive(TRANSLATE_SPEED, -24, -24);
        encoderDrive(TRANSLATE_SPEED, -17, 17);
        encoderDrive(TRANSLATE_SPEED, 50, 50);
    }
