...
//        manipM.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
    ...
    public void runDrive() {
        ...
        v1 = driveV - 0.5 * strafeV + rotateV;
        v2 = driveV + 1.6 * strafeV + rotateV;
        v3 = driveV + 0.5 * strafeV - rotateV;
        v4 = driveV - 1.5 * strafeV - rotateV;
    ...
    public void runManipulator() {
        if (this.gamepad2.left_bumper) {
            ...
            target = manipM.getCurrentPosition() - 1000;
            manipM.setTargetPosition(target);
            manipV = -.5;
            manipM.setPower(manipV);
        } else {
            manipV = 0;
