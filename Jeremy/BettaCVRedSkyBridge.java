...
public class BettaCVRedSkyBridge extends LinearOpMode {
    ...
    public void runFoundationSector() {
        robot.runDrive("d", robot.TRANSLATE_SPEED, -21,
                21, 90);
        robot.runDrive("d", robot.TRANSLATE_SPEED, 10,
                10, 0);
        robot.runFoundationMover("down");
        robot.runDrive("d", robot.TRANSLATE_SPEED, -20,
                -20, 0);
        robot.runFoundationMover("up");
        robot.runDrive("d", robot.TRANSLATE_SPEED, -6,
                -6, 6);
        robot.runDrive("d", robot.TRANSLATE_SPEED, 21,
                -21, 90);
        robot.runDrive("d", robot.TRANSLATE_SPEED, -21,
    ...
    public void runVisionSector() {
        ...
        if (valLeft == 0) {
            ...
            robot.runDrive("d", robot.TRANSLATE_SPEED, 42,
                    -42, 180);
            robot.runDrive("d", robot.TRANSLATE_SPEED, 51,
                    51, 0);
            ...
            robot.runDrive("s", robot.TRANSLATE_SPEED, -3,
                    -3, 0);
            robot.runDrive("d", robot.TRANSLATE_SPEED, -19,
                    -19, 0);
            ...
            robot.runDrive("d", robot.TRANSLATE_SPEED,
                    -42, 42, 180);
            robot.runDrive("d", robot.TRANSLATE_SPEED, 61,
                    61, 0);
            ...
            robot.runDrive("s", robot.TRANSLATE_SPEED, 23,
                    23, 0);
            ...
            robot.runDrive("d", robot.TRANSLATE_SPEED, 67,
                    67, 0);
